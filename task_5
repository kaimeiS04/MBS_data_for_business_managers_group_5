...
InputCollect <- robyn_inputs(
  ...
  paid_media_spends = c("tv_spend", "newspaper_spend", "youtube_performance_spend", "search_spend", "facebook_newsfeed_spend", "youtube_brand_spend"), # mandatory input
  paid_media_vars = c("tv_gross_rating_points", "newspaper_readership", "youtube_performance_impressions", "search_clicks", "facebook_newsfeed_impressions","youtube_brand_impressions"), # mandatory.
